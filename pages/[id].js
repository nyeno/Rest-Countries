    ...
    return (
      <div className=''>
        <div className='py-10 flex justify-between px-[5vw] lg:px-16 '>
          <button onClick={() => router.back()} className="px-8 py-2 rounded-lg shadow bg-white dark:bg-dark-element">
            <ArrowBackIcon fontSize='small' className='mr-3'/>
            Back
          </button>
          <button onClick={() => router.push('/')} className="px-6 py-2 rounded-lg shadow bg-white dark:bg-dark-element">
        ...
        <section className='lg:flex lg:justify-between px-[5vw] lg:px-16'>
            <div className='lg:basis-3/4 my-8 lg:my-0'>
              <img src={country[0].flags.svg} className="rounded-xl lg:w-5/6 w-full shadow" />
            </div>
            <div className='lg:grid lg:grid-cols-2'>
                <h1 className='col-span-2 text-3xl font-bold lg:mb-0 my-8'> { country[0].name } </h1>
                ...
                {country[0].borders &&
                        <div className='col-span-2 font-semibold lg:flex items-center mt-10 lg:mt-6'>
                            ...
                            <div className='basis-3/4 lg:ml-4 mt-2 lg:mt-0 space-y-4 '>
                              ...
                              <button onClick={handleClick} className='px-6 py-2 lg:ml-4 mr-4 font-normal shadow rounded-md bg-white dark:bg-dark-element' key={border}>
